...
public class ResetFramework : EditorWindow
{
    ...
    {
        string[] folders = new string[] { "Assets/EvaluationFrameworkROSUnity/EvaluationParameterStorage",
                                          "Assets/EvaluationFrameworkROSUnity/ObjectiveValueStorage",
                                          "Assets/EvaluationFrameworkROSUnity/ROSParameterStorage"};
    ...
    public static void ResetManager()
    {
        ...
        ROSParameterManager.assets.Clear();
        ROSParameterManager.objStrings.Clear();
        ROSParameterManager.parameterList.Clear();
        ROSParameterManager.rosParametersSaved = false;

        ObjectiveValueManager windowObjVal = GetWindow<ObjectiveValueManager>();
        windowObjVal.Close();
        ROSParameterManager windowROSParam = GetWindow<ROSParameterManager>();
        windowROSParam.Close();
    }
}
